...
const socialLinks = [
  {
    name: "Instagram",
    url: "https://www.instagram.com/_tisyaofficial/",
    icon: (
  ...
  {
    name: "Facebook",
    url: "https://www.facebook.com/profile.php?id=61582533329144",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/company/tisyaofficial/",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "X (Twitter)",
    url: "https://x.com/_tisyaofficial",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
